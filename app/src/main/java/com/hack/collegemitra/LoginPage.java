...
import com.hack.collegemitra.MainActivity;
import com.hack.collegemitra.R;
import com.hack.collegemitra.Register;
        ...
        btnlgn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(LoginPage.this,"Empty email",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(password)){
                    Toast.makeText(LoginPage.this,"Empty pws",Toast.LENGTH_SHORT).show();
                    return;
                }
